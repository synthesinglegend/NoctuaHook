...
vgui::HFont				g_MenuFontTabs1;
vgui::HFont				g_MenuFontTabs2;
vgui::HFont				g_MenuFontTabs3;
vgui::HFont				g_MenuFontTabs4;
vgui::HFont				g_MenuFontTabs5;
...
{
	return 90.f + g_CVars.Visuals.ViewModelFOV;
}
...
void Hook( void )
{
	...
	ClientModeVMT = new CVMTHook(pdwClientModeVMT);
	ClientModeVMT->HookFunction(16, Hooked_OverrideView);
	ClientModeVMT->HookFunction(32, Hooked_GetViewModelFOV);
