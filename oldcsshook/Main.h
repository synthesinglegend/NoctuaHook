...
extern void SendMove(void);
//extern void SendMove1(void);
...
extern void __stdcall Hooked_OverrideView(CViewSetup* setup);
...
extern IMaterial* __fastcall Hooked_FindMaterial(void*, void*, const char*, const char*, bool, const char*);