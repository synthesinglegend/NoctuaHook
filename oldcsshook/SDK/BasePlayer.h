...
#define CLASSNAME BasePlayer
	...
	public:
		...
		NETVAR(int, DT_CSPlayer, m_iAccount);
		...
		VFUNCN0(UpdateClientSideAnimation, Index2Offset(156));
		NETVAR(bool, DT_BaseAnimating, m_bClientSideAnimation);
		NETVAR(int, DT_BasePlayer, m_iFOV);
		NETVAR(int, DT_BasePlayer, m_iDefaultFOV);
		...
		*/
		...
		inline const Vector EyePosition()
		{
			return m_vecOrigin() + m_vecViewOffset(); // + m_vecVelocity( ) * g_pGlobals->interval_per_tick;
		}
		...
		inline void* m_PlayerAnimState()
		{
			return *(void**)(this + 0xF80);
		}

		inline int& m_iAccumulatedBoneMask()
		{
			return *(int*)((DWORD)this + 0x49C + 0x4);
		}

		inline int& m_nReadableBones()
		{
			return *(int*)((DWORD)this + 0x4A8 + 0x4);
		}

		inline int& m_nWritableBones()
		{
			return *(int*)((DWORD)this + 0x4AC + 0x4);
		}

		inline int& m_iPrevBoneMask()
		{
			return *(int*)((DWORD)this + 0x498 + 0x4);
		}

		inline bool IsBoneAccessAllowed()
		{
			Vector origin = *(Vector*)((DWORD)this + 0x29C);
			bool ret = (origin != Vector(0, 0, 0));
			return ret;
		}

		inline int& m_iMostRecentModelBoneCounter()
		{
			return *(int*)((DWORD)this + 0x494 + 0x4);
		}

		inline int& g_iModelBoneCounter()
		{
			return *(int*)((DWORD)0x243B0A50);
		}

		inline void*& m_pIk()
		{
			return *(void**)((DWORD)this + 0x480 + 0x4);
		}
		...
		inline DWORD GetAnimstateInterface()
		{
			return *reinterpret_cast<DWORD*>(reinterpret_cast<DWORD>(this) + 0xF80);
		}
