#ifndef CCSPlayerAnimState_H
#define CCSPlayerAnimState_H
...
namespace Valve
{
	...
	//	virtual ~CBasePlayerAnimState() = 0;
		...
		virtual bool ShouldChangeSequences(void) = 0;
		virtual bool ShouldBlendAimSequenceToIdle() = 0;
		virtual float SetOuterBodyYaw(float flValue) = 0;
		virtual bool CanThePlayerMove() = 0;
		...
		virtual int CalcSequenceIndex(const char* pBaseName, ...) = 0;
		virtual void		ComputePoseParam_MoveYaw(CStudioHdr* pStudioHdr) = 0;
		virtual void		ComputePoseParam_BodyPitch(CStudioHdr* pStudioHdr) = 0;
		virtual void		ComputePoseParam_BodyYaw() = 0;

		virtual void		ResetGroundSpeed() = 0;

		CModAnimConfig		m_AnimConfig;
		// + 4
		IClientEntity* m_pOuter;
		...
		char	m_IdleSequenceTransitioner[20];
		char	m_SequenceTransitioner[20];
	};
