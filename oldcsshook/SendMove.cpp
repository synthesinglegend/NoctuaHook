...
typedef void (*SendMove_t)(void*, void*);
SendMove_t _SendMove;

void __fastcall Hooked_SendMove(void* ecx, void* edx)
{
	SendMove();
}
...
void SendMove(void)
{
	//_SendMove = (SendMove_t)DetourFunction((PBYTE)((DWORD)537142224), (PBYTE)Hooked_SendMove);
