...
public:
	...
	void MenuStringNormal1(bool, bool, int, int, Color, const char*, ...);
	void MenuStringNormal2(bool, bool, int, int, Color, const char*, ...);
	void MenuStringNormal5(bool, bool, int, int, Color, const char*, ...);
	void MenuStringNormal3(bool, bool, int, int, Color, const char*, ...);
	void MenuStringNormal4(bool, bool, int, int, Color, const char*, ...);
